/* jquery.poptrox.js v2.5.2-dev | (c) @ajlkn | github.com/ajlkn/jquery.poptrox | MIT licensed */ ! function(e) {
    e.fn.poptrox_disableSelection = function() {
        ...
        if (s.album) {
            e(this).on("click", s.album, function(ev) {
                x.trigger("poptrox_load", ev.currentTarget);
                if (u && u.length > 0) {
                    ev.preventDefault();
                    ev.stopPropagation();
                    x.trigger("poptrox_open", [0]);
                }
            });
        } else {
            x.trigger("poptrox_load", this);
        }
        ...
        return l.on("resize orientationchange", function() {
            ...
            return !(!h || s.usePopupForceClose) || (h = !0, x.hide().trigger("poptrox_reset"), 
        ...
        }).on("poptrox_load", function(ev, body) {
            u = []; 
            e(body).find(s.selector).each(function(o) {
                var t, p, i = e(this),
                    r = i.find("img"),
                    n = i.data("poptrox");
                if ("ignore" != n && i.attr("href")) {
                    t = {
                        src: i.attr("href"),
                        captionText: i.attr("title") || r.attr("title"),
                        width: null,
                        height: null,
                        type: null,
                        object: null,
                    ...
                    u.push(t), 
                    r.removeAttr("title"), 
                    i.css("cursor", "pointer").css("outline", 0).on("click", function(e) {
